  ...
  return (
    <Layout>
      <div className="w-screen h-screen flex justify-center items-center p-5">
        {product !== undefined ? (
          <div className="h-1/2 flex bg-orange-300 rounded=md">
            ...
            <div className="flex flex-col gap-y-5 justify-center">
              ...
              <button className="p-3 bg-amber-600 text-white rounded-md font-semibold w-40 h-14 hover:bg-amber-800">
                Beli sekarang
              </button>
            </div>
          </div>
        ) : (
          <h2 className="text-amber-700 font-semibold text-lg">
            Maaf produk yang anda cari kosong boss
          </h2>
        )}
      </div>
    </Layout>
